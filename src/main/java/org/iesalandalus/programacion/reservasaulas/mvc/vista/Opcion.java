...
public enum Opcion {
	...
	/*
	 * Crea el enumerado Opcion que será el encargado de representar el menú de
	 * opciones de nuestra aplicación y que se adecue al diagrama de clases
	 * expuesto. Haz un commit.
	 */
